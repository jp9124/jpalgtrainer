...
const builtinSets = [
  {
    ...
    cases: [
      ...
      // The sheet's alg ends with a whole-puzzle x2 reorientation; this
      // puzzle's move engine only supports y/y' rotations (matching
      // `controls` above), so it's dropped here. Scramble/solve stays
      // self-consistent either way, since the scramble is generated by
      // inverting this same alg (see TrainerContext.jsx's learnScrambleAlgFor).
      { name: "4 Flip", alg: "R U' R' L' U L", group: "Flipped Edges" },
      // Polish Flip
